...
<p class="alert alert-danger"><strong>NOTE: This tutorial is outdated and needs to be updated for the 2020 Game Engine. Please see the <a href="https://github.com/battlesnakeofficial/starter-snake-node">Node Starter Snake</a> for instructions on getting started using JavaScript and Heroku.</strong></p>
